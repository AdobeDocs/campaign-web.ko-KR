...
+ 메시지 및 게재 {#msg}
  ...
  + 이메일 {#email}
    ...
    + [콘텐츠 실험 만들기](email/ab-testing.md)
  ...
  + {hide-from-toc}[WhatsApp 시작](whatsapp/get-started-whatsapp.md)
  + {hide-from-toc}[WhatsApp 게재 만들기](whatsapp/create-whatsapp.md)
...
+ 콘텐츠 관리 {#content}
  ...
  + 이메일 디자인 {#email-design}
    ...
    + 이메일 구성 시작하기 {#start-design}
      ...
      + [이메일 콘텐츠에 테마 적용](email/apply-email-themes.md)
...
+ 오퍼 관리 {#offers}
  + [오퍼 관리 시작](offers/gs-offer-management.md)
  + [오퍼 환경 설정 검토](offers/offer-environment.md)
  + [오퍼 공간 만들기 및 관리](offers/offer-space.md)
  + [오퍼 만들기 및 게시](offers/create-offer.md)
  + [오퍼 스키마에 편집 가능한 목록 추가](offers/offer-editable-list.md)
+ 프로필 및 대상자 {#audiences}
...
+ 워크플로 {#wf}
  ...
  + 워크플로 활동을 사용하여 작업하기 {#design-workflows}
    ...
    + [자동화된 게재](workflows/activities/automated-delivery.md)
    ...
    + [지속적인 게재](workflows/activities/continuous-delivery.md)
    + [데이터 로딩(RDBMS)](workflows/activities/data-loading-rdbms.md)
...
+ 데이터베이스 쿼리 {#query-database}
  ...
  + {hide-from-toc}[쿼리 샘플](query/query-samples.md)
...
+ 구성 {#conf}
  ...
  + 스키마 작업 {#schemas}
    ...
    + [스키마 액세스 및 구성](administration/schemas-browse-access.md)
    + [목록 열 구성](administration/schemas-list-columns.md)
    + [맞춤형 필터 추가](administration/schemas-custom-filters.md)
    + [사용자 정의 필드 편집](administration/schemas-custom-fields.md)
    + [컬렉션 목록 추가](administration/schemas-collection-lists.md)
    + [데이터에 대한 작업 제어](administration/schemas-action-data.md)
  ...
  + [동적 JavaScript 페이지 작업](administration/dynamic-javascript-pages.md)
