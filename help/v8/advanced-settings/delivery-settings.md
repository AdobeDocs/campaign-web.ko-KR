...
이 섹션에서는 사용 가능한 **대상 매핑** 중 원하는 옵션을 선택할 수 있습니다. 대상 매핑은 Adobe Campaign v8 콘솔에서 정의됩니다. 대상 매핑은 작업에서 처리하는 데이터 유형입니다. 대상 모집단을 정의할 수 있습니다. 받는 사람, 계약 수혜자, 운영자, 구독자 등 [대상 매핑에 대해 자세히 알아보기](../audience/targeting-dimensions.md).
...
>title="SMS 게재 설정"
>abstract="SMS 게재 매개변수는 SMS 게재에 적용되는 기술 설정입니다. 발신자 주소, 서비스 매개변수, 전송 모드 등을 정의할 수 있습니다. 이 옵션은 숙련된 사용자로만 제한됩니다."

SMS 게재 매개변수는 SMS 게재에 적용되는 기술 설정입니다. 발신자 주소, 서비스 매개변수, 전송 모드 등을 정의할 수 있습니다. 이 옵션은 숙련된 사용자로만 제한됩니다.
...
이메일 게재에 추가 SMTP 매개변수를 추가할 수 있습니다. 게재 설정의 SMTP 탭에서 수행할 수 있습니다.
...
이 창에 입력한 스크립트는 줄당 name:value 형식의 헤더를 참조해야 합니다.
...
게재에 변수를 추가할 수 있으며, 이는 추적 및 개인화에 유용할 수 있습니다. 이러한 변수는 게재 콘텐츠와 워크플로 모두에서 액세스할 수 있습니다. 저장된 변수는 게재 내의 모든 메시지에서 일정하게 유지되는 값을 설정하는 데 사용됩니다. 게재 템플릿에서도 구성할 수 있습니다.
