...
## 사용자 지정 연산자 그룹에 대한 권한

새 대상을 만들면 워크플로가 자동으로 만들어지고 **[!UICONTROL 프로필 및 대상]** / **[!UICONTROL 작업]** / **[!UICONTROL 워크플로 타깃팅]** 폴더에 저장됩니다.

사용자 지정 연산자 그룹에 할당되어 대상자를 만들 때 &quot;권한이 없습니다&quot; 오류가 발생하는 경우 연산자 그룹에 이 폴더에 대한 필요한 권한이 있는지 확인해야 합니다.

이 문제를 해결하려면 관리자는 Campaign 콘솔의 폴더 보안 섹션에 사용자 지정 연산자 그룹을 추가해야 합니다. [폴더에 대한 권한을 관리하는 방법 알아보기](../get-started/permissions.md#folder-permissions)
