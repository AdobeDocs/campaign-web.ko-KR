...
>title="캠페인"
>abstract="캠페인 목록을 탐색하십시오. 캠페인을 선택하면 해당 콘텐츠, 게재 및 세부 정보를 볼 수 있습니다. 상태나 시작/종료일, 또는 사용자 정의 규칙에기준으로 필터링할 수 있습니다. 완료된 캠페인에 대한 보고서도 볼 수 있습니다. **캠페인 만들기** 버튼을 클릭하여 새 캠페인을 추가합니다. 템플릿을 보고 만들려면 **템플릿** 탭으로 이동합니다."
