...
>title="캠페인"
>abstract="캠페인 목록을 탐색합니다. 콘텐츠, 게재 및 세부 정보를 보려면 캠페인을 선택합니다. 상태 또는 시작일/종료일별로 또는 사용자 정의 규칙을 기준으로 필터링할 수 있습니다. 완료된 캠페인에 대한 보고서도 볼 수 있습니다. **캠페인 만들기** 버튼을 클릭하여 새 캠페인을 추가합니다. 템플릿을 보고 만들려면 **템플릿** 탭으로 이동합니다."
