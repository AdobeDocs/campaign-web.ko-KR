...
>title="캠페인"
>abstract="캠페인 목록을 탐색합니다. 콘텐츠, 게재 및 세부 정보를 보려면 캠페인을 선택합니다. 상태, 시작/종료 날짜 또는 사용자 지정 규칙으로 필터링할 수 있습니다. 완료된 캠페인에 대한 보고서를 볼 수도 있습니다. 다음을 클릭합니다. **캠페인 만들기** 단추를 클릭하여 새 캠페인을 추가합니다. 다음으로 이동 **템플릿** 탭을 사용하여 템플릿을 보고 만들 수 있습니다."
