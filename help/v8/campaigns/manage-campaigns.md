...
캠페인 템플릿에는 새 워크플로우를 만드는 데 다시 사용할 수 있는 사전 구성된 설정이 포함되어 있습니다. 시작하는 데 도움이 되는 기본 제공 템플릿 세트를 사용할 수 있습니다. 캠페인 템플릿을 만들고 구성한 다음 그 템플릿에서 캠페인을 만들 수 있습니다.
...
1. 다음 항목 선택 **템플릿** 을 입력하여 캠페인에 대한 레이블을 제공합니다. 이를 통해 이미 만들어진 템플릿을 기반으로 새 템플릿을 만들 수 있습니다.
