...
**[!UICONTROL 찾아보기]** 탭에는 캠페인의 현재 상태, 시작 및 종료 날짜, 만든 날짜, 마지막으로 수정한 시간 등에 대한 정보가 있습니다. 목록의 오른쪽 상단에 있는 **사용자 지정 레이아웃에 대한 열 구성** 아이콘을 클릭하여 표시된 열을 사용자 지정할 수 있습니다. 이렇게 하면 캠페인 목록에서 열을 추가 또는 제거하고 정보를 재정렬할 수 있습니다.
...
기본적으로 캠페인 화면에 **목록 보기**(인벤토리)가 표시됩니다. 보기 전환을 사용하여 언제든지 **타임라인 보기**(으)로 전환할 수 있습니다. 두 보기 모두 동일한 캠페인을 표시하고 동일한 필터 및 검색을 공유합니다. 한 보기에서 필터 또는 검색을 변경하면 다른 보기는 동일한 선택을 반영합니다.

타임라인 보기를 통해 시간에 따른 캠페인을 시각화하고 관리할 수 있습니다. 모든 캠페인을 시간 기반 형식으로 볼 수 있으므로 마케팅 활동을 보다 쉽게 계획, 예약 및 조정할 수 있습니다.

![](assets/timeline-view.png)

**타임라인이 작동하는 방식:**

* 타임라인에는 캠페인이 시작 및 종료 날짜에 따라 표시됩니다. 여러 날에 걸친 캠페인은 관련 날짜에 걸쳐 표시됩니다.
* 주, 월 또는 일별로 탐색할 수 있습니다. 날짜 선택기 또는 화살표 단추를 사용하여 마침표 사이를 이동합니다. **오늘** 단추를 사용하여 현재 날짜로 빠르게 돌아갈 수 있습니다.
* 캠페인을 선택하면 상태, 시작 및 종료 날짜, 워크플로우 목록, 게재 목록 등 캠페인 세부 정보가 표시된 오른쪽 패널이 열립니다. 패널에서 해당 워크플로우 및 게재로 이동할 수 있습니다.
* 진행 중인 캠페인은 많은 캠페인이 동일한 날짜에 속할 때 디스플레이에서 우선 순위가 지정됩니다.
* 많은 캠페인이 하루(예: 월 보기)에 속하면 **자세히** 컨트롤을 확장하여 해당 날짜의 전체 세트를 보거나 주 또는 일 보기로 전환하여 자세한 내용을 볼 수 있습니다.
