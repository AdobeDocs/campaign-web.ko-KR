...
>[!CAUTION]
>
> 이 메서드를 사용하는 경우 Adobe Experience Manager Assets Essentials의 이미지를 참조할 수 없습니다. HTML 코드에서 참조되는 이미지는 공용 위치에 저장해야 합니다.
...
1. 왼쪽 창을 사용하여 활용 [!DNL Journey Optimizer] 개인화 기능.
...
1. 을(를) 클릭합니다. **[!UICONTROL 미리 보기]** 테스트 프로필을 사용하여 메시지 디자인 및 개인화를 확인하는 단추입니다.
