...
>title="나만의 콘텐츠 조각 정의"
>abstract="조각 속성 및 만들려는 조각의 유형을 정의합니다. 그런 다음 이메일 디자이너 또는 표현식 편집기를 사용하여 조각의 콘텐츠를 구성할 수 있습니다."
...
>title="조각 속성"
>abstract="조각 레이블을 입력합니다. 필요한 경우 조각 내부 이름, 해당 폴더 및 설명과 같은 추가 옵션을 정의할 수 있습니다."

>[!CONTEXTUALHELP]
>id="acw_fragments_type"
>title="컨텐츠 조각 유형"
>abstract="만들려는 조각 유형을 선택합니다. **시각적 조각**&#x200B;은(는) 여러 전자 메일 게재 또는 콘텐츠 템플릿에서 재사용할 수 있는 미리 정의된 시각적 블록입니다. **표현식 조각**&#x200B;은 표현식 편집기의 전용 항목에서 사용할 수 있는 사전 정의된 표현식입니다."
...
1. 조각 레이블을 입력합니다. 필요한 경우 조각 내부 이름, 해당 폴더 및 설명과 같은 추가 옵션을 정의할 수 있습니다.
...
>title="조각으로 저장"
>abstract="콘텐츠를 시각적 조각으로 저장하려면 개인화 필드 및 동적 콘텐츠를 포함하여 조각에 포함할 요소를 선택합니다. 서로 인접한 섹션만 선택할 수 있습니다. 빈 구조나 다른 콘텐츠 조각은 선택할 수 없습니다. 그러면 이 콘텐츠는 독립 실행형 조각 이 되고, 조각 목록에 추가되고, 전용 메뉴에서 액세스할 수 있습니다. Campaign 내에서 이메일 또는 콘텐츠 템플릿을 작성할 때 이 조각을 사용할 수 있습니다."
