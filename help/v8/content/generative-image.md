...
audience: end-user
title: 생성 콘텐츠
description: AI를 사용하여 이미지를 생성하는 방법 알아보기
...
Adobe Campaign 웹의 AI를 사용하여 이메일, 랜딩 페이지 및 푸시 알림에서 메시지를 향상시키는 매력적인 시각적 콘텐츠를 제작할 수 있습니다. AI는 이미지를 생성하고 최적화하는 데 도움이 되므로 콘텐츠가 시각적으로 매력적이고 브랜드에 맞게 조정됩니다.

## 이메일 및 랜딩 페이지의 경우 {#email-web-channels}

AI를 사용하여 이메일 게재 및 랜딩 페이지에 대한 완전한 시각적 경험을 생성합니다. 이 기능을 사용하면 디지털 터치포인트에서 대상자와 공감하는 온브랜드, 주목을 끄는 이미지를 만들 수 있습니다.

### 액세스 및 구성 {#access-configure}

AI로 이미지 생성을 시작하려면 먼저 게재를 설정하고 콘텐츠 편집기를 엽니다. 아래 단계에 따라 작업 공간을 준비하고 콘텐츠 생성 패널에 액세스합니다.
...
1. 변경할 자산을 선택하고 **[!UICONTROL 콘텐츠 생성]** 메뉴에 액세스합니다.

   ![Adobe Campaign 웹에서 텍스트 구성 요소 선택을 보여 주는 스크린샷](assets/image-genai-1.png){zoomable="yes"}

### 이미지 생성 {#generate-content}

AI를 사용하여 효과적인 프롬프트를 만들고 시각적으로 매력적인 이미지를 생성하도록 이미지 설정을 구성하는 방법에 대해 알아봅니다. 종횡비, 시각적 강도 및 조명과 같은 매개 변수를 사용자 지정하여 브랜드 및 캠페인 목표에 맞는 이미지를 만들 수 있습니다.

1. AI를 사용하여 선택한 콘텐츠를 기반으로 새 콘텐츠를 개인화하려면 **[!UICONTROL 참조 스타일]** 옵션을 활성화하십시오.
...
AI를 사용하여 푸시 알림에 대한 매력적인 이미지를 생성함으로써 시선을 사로잡으며 대상자와 공감하는 시각적으로 매력적인 모바일 커뮤니케이션을 만들 수 있습니다.

### 액세스 및 구성 {#mobile-access-configure}

AI를 사용하여 푸시 알림용 이미지 생성을 시작하려면 먼저 게재를 설정하고 콘텐츠 생성을 엽니다.

1. 푸시 알림 게재를 만들고 구성한 후 **[!UICONTROL 콘텐츠 편집]**&#x200B;을 클릭합니다. [자세히 알아보기](../push/create-push.md)

1. **[!UICONTROL 콘텐츠 생성 표시]** 메뉴에 액세스합니다.

   ![콘텐츠 생성 표시 메뉴를 보여 주는 스크린샷](assets/push-img-1.png){zoomable="yes"}
...
1. **[!UICONTROL 프롬프트]** 필드에 생성할 내용을 설명하여 내용을 미세 조정하십시오.
   ...
   ![프롬프트 필드 및 옵션을 사용하여 콘텐츠 생성](assets/push-img-2.png){zoomable="yes"}
