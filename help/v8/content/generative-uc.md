---
title: 콘텐츠 사용 사례 생성
description: 사용 사례를 통해 AI를 사용하여 콘텐츠를 생성하는 방법에 대해 알아봅니다
...
![콘텐츠 생성으로 기존 콘텐츠 재사용 시연](assets/do-not-localize/gen-ai-reuse-text.gif)
...
1. 콘텐츠 생성 내의 **[!UICONTROL 원본 콘텐츠 사용]** 기능을 켜서 게재 이름 및 대상 대상을 포함하여 게재 세부 사항에 따라 새 콘텐츠를 사용자 지정합니다.
...
![콘텐츠 생성을 통해 콘텐츠 변형을 개선하는 데모](assets/do-not-localize/gen-ai-variation.gif)
...
1. **[!UICONTROL 미리 보기]** 창에서 다음을 포함한 추가 사용자 지정을 위해 **[!UICONTROL 다시 정의]** 옵션으로 이동합니다.
   ...
   * **[!UICONTROL 정교함]**: AI를 사용하여 특정 지점을 정교화하고 더 나은 참여를 위해 더 깊이 있고 자세한 정보를 제공합니다.

   * **[!UICONTROL 요약]**: 자세한 내용을 보려면 AI를 사용하여 콘텐츠를 편집/다듬어 전자 메일 수신자가 쉽게 요약할 수 있는 간결한 요약을 만드십시오.

   * **[!UICONTROL 구문 변경]**: 다양한 대상자에게 콘텐츠를 새로 제공하는 데 도움이 되도록 다양한 방법으로 메시지를 제시하여 AI를 사용하여 메시지를 편집/구체화합니다.

   * **[!UICONTROL 더 간단한 언어 사용]**: AI를 사용하여 언어를 편집/개선하여 메시지를 명확하고 모든 독자가 액세스할 수 있도록 합니다.
...
![콘텐츠 생성을 통해 유사한 이미지를 생성하는 데모](assets/do-not-localize/uc-image-similar.gif)
...
![콘텐츠 생성을 위한 스타일 참조 업로드 데모](assets/do-not-localize/uc-image-reference.gif)
...
1. AI를 사용하여 참조 자료를 사용하여 새 콘텐츠를 생성하려면 **[!UICONTROL 참조 스타일]** 옵션을 켜십시오.
...
![프랑스어, 스페인어, 독일어의 여러 언어로 콘텐츠를 생성하는 애니메이션 데모](assets/do-not-localize/ai-language.gif)

프롬프트를 명시적 언어 설정과 결합하여 AI가 지원하는 언어로 텍스트를 생성합니다.
...
**참조 콘텐츠**, 웹 페이지 또는 업로드된 파일을 추가하여 AI에 더 많은 컨텍스트를 제공할 수 있으므로 생성된 복사와 제안이 원본 자료에 더 가깝게 유지됩니다.
...
1. 수정할 자산을 선택하고 **[!UICONTROL 콘텐츠 생성]** 메뉴를 엽니다.
