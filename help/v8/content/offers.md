...
Adobe Campaign v8 웹을 사용하면 콘솔에서 만든 이메일 오퍼를 사용하여 보낼 수 있습니다 **[!UICONTROL 상호 작용]** 모듈. 상호 작용 및 콘솔에서 오퍼 카탈로그를 관리하는 방법에 대한 자세한 내용은 [Campaign V8 설명서](https://experienceleague.adobe.com/docs/campaign/campaign-v8/offers/interaction.html)
