...
>title="콘텐츠 실험"
>abstract="콘텐츠 실험을 통해 타겟 대상자에게 가장 적합한 성과를 측정하기 위해 여러 A/B 테스트 게재 변형을 정의할 수 있습니다. 게재 콘텐츠, 제목 또는 발신자를 다양하게 하여 다양한 버전을 테스트하고 가장 좋은 결과를 도출하는 변형을 결정할 수 있습니다."
