...
>title="콘텐츠 템플릿"
>abstract="디자인 프로세스를 가속화하고 개선하기 위해 독립형 이메일 템플릿을 만들어 Adobe Campaign 전체에서 사용자 정의 콘텐츠를 쉽게 재사용할 수 있습니다. 이러한 콘텐츠 템플릿은 기본 제공 또는 사용자 지정 템플릿을 기반으로 처음부터 디자인되거나, 기존 콘텐츠에서 만들어지거나, 콘텐츠 템플릿 편집기에서 가져올 수 있습니다."

디자인 프로세스를 가속화하고 개선하기 위해 독립 실행형 템플릿을 만들어 사용자 지정 콘텐츠를 여러 곳에서 쉽게 재사용할 수 있습니다 [!DNL Adobe Campaign]. 이러한 콘텐츠 템플릿은 기본 제공 또는 사용자 지정 템플릿을 기반으로 처음부터 디자인되거나, 기존 콘텐츠에서 만들어지거나, 콘텐츠 템플릿 편집기에서 가져올 수 있습니다.
