...
1. 새 게재를 만들려면 **[!UICONTROL 게재]** 왼쪽 레일의 메뉴를 클릭하고  **[!UICONTROL 게재 만들기]** 버튼을 클릭합니다.

1. 선택 **[!UICONTROL 이메일]** 을 채널로 선택하고 템플릿을 선택합니다.
...
1. 을(를) 클릭합니다. **[!UICONTROL 게재 만들기]** 확인할 단추입니다.
1. 게재에 대한 레이블을 입력하고 필요에 따라 추가 옵션을 구성합니다.
...
1. 전자 메일 콘텐츠 만들기를 시작하려면 전자 메일 게재를 열고 **[!UICONTROL 컨텐츠 편집]** 버튼을 클릭합니다.
...
1. 전자 메일 콘텐츠를 디자인하려면 **[!UICONTROL 이메일 본문 편집]** 버튼을 클릭합니다.
...
전자 메일 전송을 예약하려면 전자 메일 게재를 열고 **예약** 섹션을 참조하십시오. 를 사용하십시오 **[!UICONTROL 예약 활성화]** 을(를) 활성화하려면 전환하고 원하는 날짜 및 전송 시간을 설정합니다. 게재를 전송하면 실제 전송은 정의한 연락 날짜에 시작됩니다.

기본적으로 **[!UICONTROL 보내기 전 확인 활성화]** 옵션이 활성화되어 있습니다. 이 옵션을 사용하려면 예약된 날짜 및 시간에 이메일을 전송하기 전에 전송을 확인해야 합니다. 예약된 날짜와 시간에 자동으로 이메일을 보내야 하는 경우 이 옵션을 비활성화할 수 있습니다.
...
1. 이메일을 검토하려면 **[!UICONTROL 검토 및 보내기]**. 구성된 모든 속성, 대상 및 일정과 함께 이메일 미리 보기가 표시됩니다. 수정 단추를 클릭하여 이러한 요소를 편집할 수 있습니다.
