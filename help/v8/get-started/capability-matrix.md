...
>[!NOTE]
>
>이들 활동 중 일부는 클라이언트 콘솔에서만 사용할 수 있지만 **데이터 보강**, **파일 로드**, **데이터 소스 변경** 또는 **차원 변경** 활동 등 일부는 Campaign Web 사용자 인터페이스에서 사용할 수 있습니다. [Campaign 웹 사용자 인터페이스에서 타기팅 및 데이터 관리 활동에 대해 자세히 알아봅니다.](../workflows/activities/about-activities.md#targeting)
