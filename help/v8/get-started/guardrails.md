...
Campaign Web에서 아직 지원되지 않는 워크플로우 활동은 읽기 전용이며 호환되지 않는 활동으로 표시됩니다. 워크플로우를 실행하고, 메시지를 전송하며, 로그를 확인하는 등의 작업은 계속 수행할 수 있습니다. Campaign Web과 클라이언트 콘솔 모두에서 사용할 수 있는 워크플로우 활동은 편집할 수 있습니다.
