...
왼쪽 탐색 메뉴의 대부분 링크에는 **게재** 또는 **캠페인** 목록 등 오브젝트 목록이 표시됩니다. 일부 목록 화면은 읽기 전용입니다. 아래 설명대로 목록 표시를 사용자 지정하고 해당 목록을 필터링할 수 있습니다.
...
## 사용자 지정 필터{#list-custom-filters}

데이터에 사용자 지정 필터를 만들려면 필터 하단으로 이동하여 **규칙 추가** 버튼을 클릭합니다.
