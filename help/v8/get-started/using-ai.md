...
# AI 기반 Knowledge Assistant 사용 {#using-ai}

제품 상황별 도움말 상자에서 Q&amp;A AI 기반 Knowkedge Assistant를 사용하여 제품 설명서 및 현재 제품 컨텍스트를 기반으로 AI가 생성한 빠른 답변을 얻을 수 있습니다.

>[!CAUTION]
>
>이 기능은 Alpha 버전에서 사용할 수 있으며 사전 통지 없이 변경될 수 있습니다.
>
>이 기능은 다음에서만 사용할 수 있습니다. **영어**. 이 버전에서는 다른 언어가 지원되지 않습니다.


상황별 도움말에 임베드된 **생성형 AI 기반 Knowledge Assistant**&#x200B;는 설명서 검색을 혁신하고 방대한 설명서 저장소를 손쉽게 선별하여 필요한 정확한 정보를 즉시 찾아내는 방법에 대한 질문의 답변을 제공합니다.
...
Adobe Campaign AI 기반 Knowledge Assistant에서 도움을 제공하지만 사실을 확인해야 합니다. 잘못된 정보, 부정확하거나 오해의 소지가 있는 답변이 출력될 수 있습니다. 모든 도움말 상자에 링크된 제품 설명서를 확인하십시오.

인공 지능 및 머신 러닝 모델은 시간이 지남에 따라 개선되어 특정 사용 사례를 보다 잘 처리하게 됩니다. Campaign AI 기반 Knowledge Assistant는 향후 몇 개월에 걸쳐 계속해서 개선될 예정입니다. 답변을 읽을 때마다 ?? ?? 버튼을 사용하여 부적절한 답변을 엔지니어에게 알리는 것이 좋습니다.

## 권장 사항  {#recommendations-ai}

AI 기반 Knowledge Assistant에 질문할 때 현재 제품 컨텍스트, 즉 현재 화면과 현재 도움말 상자의 내용이 고려됩니다.
...
또한 AI 기반 Knowledge Assistant를 최대한 활용하려면 질문할 때 다음과 같은 사항이 권장됩니다.

* 최대한 정확하고 구체적으로 작성해야 하며 모호하지 않아야 합니다. 답변이 더욱 정확하고 유용할 것입니다.
* AI 기반 Knowledge Assistant가 올바른 정보를 찾을 수 있도록 배우려는 내용에 대해 가능한 한 많은 세부 정보를 추가하십시오.
