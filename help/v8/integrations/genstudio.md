---
title: GenStudio for Performance Marketing을 사용하여 Adobe Campaign으로 작업
description: Adobe Campaign에서 GenStudio for Performance Marketing을 사용하는 방법 알아보기
...
# GenStudio for Performance Marketing 작업 {#genstudio}
...
[!DNL GenStudio for Performance Marketing] 및 [!DNL Adobe Campaign] 통합을 사용하면 회사 마케터가 함께 더 효율적으로 작업하여 프로세스를 간소화할 수 있습니다.

예를 들어 [!DNL Adobe Campaign]을(를) 사용하여 이메일 캠페인을 개발 및 자동화하는 기술 마케터는 [!DNL GenStudio]을(를) 사용하여 콘텐츠를 만드는 성능 마케터와 공동 작업을 수행할 수 있습니다.

이 통합을 통해 두 플랫폼 모두 함께 작동하여 [!DNL GenStudio]의 브랜드 내 콘텐츠를 [!DNL Adobe Campaign]&#x200B;(으)로 쉽게 통합하여 특정 고객 세그먼트를 타겟팅하고 판매를 촉진하는 매력적인 이메일을 제공할 수 있습니다.

### Adobe Campaign에서 GenStudio으로 HTML 템플릿 내보내기 {#export-from-campaign-to-genstudio}

먼저 브랜드 지침을 포함하는 [!DNL Adobe Campaign] HTML 템플릿을 [!DNL GenStudio for Performance Marketing]&#x200B;(으)로 내보낼 수 있습니다. 아래 단계를 수행합니다.

1. [!DNL Adobe Campaign]에서 전자 메일 콘텐츠에 액세스합니다. [방법 알아보기](../email/create-email.md#create-content)
...
### Adobe Campaign에서 GenStudio 경험 활용 {#leverage-genstudio-experiences}

[!DNL Adobe Campaign]&#x200B;(으)로 가져와서 방금 만든 [!DNL GenStudio] 전자 메일 변형을 활용하려면 아래 단계를 따르십시오.

1. [!DNL Adobe Campaign]에서 [전자 메일 게재를 만들기](../email/create-email.md)합니다.

1. 전자 메일 게재 대시보드에서 **[!UICONTROL 콘텐츠 편집]** 단추를 클릭합니다. [자세히 알아보기](../email/create-email.md#create-content)
