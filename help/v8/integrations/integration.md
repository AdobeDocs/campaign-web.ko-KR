...
[Campaign v8(콘솔) 설명서](https://experienceleague.adobe.com/docs/campaign/campaign-v8/connect/integration.html){target="_blank"}에서 Campaign과 연결할 수 있는 솔루션 및 앱과 관련 사용 사례를 알아봅니다.

또한 새로운 Campaign 웹 사용자 인터페이스를 사용하면 Adobe Experience Manager as a Cloud Service 환경을 연결하여 다음과 같은 사용 사례를 달성할 수 있습니다.

* Adobe 경험 관리 as a Cloud Service 자산. [자세히 알아보기](aem-assets.md)
