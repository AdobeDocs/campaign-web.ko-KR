...
1. 템플릿 선택:
   ...
   * **[!UICONTROL 구독 취소]**: 이 템플릿은 서비스 구독자에게 전송된 게재에서 이 [서비스](../audience/manage-services.md)에서 구독을 취소할 수 있도록 하는 데 사용할 수 있습니다.
...
1. 레이블과 같은 **[!UICONTROL 속성]** 필드를 채웁니다.
   ...
   랜딩 페이지의 보안을 위해 captcha를 설정할 수도 있습니다. [여기에서 자세히 알아보십시오](#captcha).

   ![](assets/lp-properties.png){zoomable="yes"}

1. **[!UICONTROL 데이터 미리 로드]** 섹션에서 아래 두 가지 옵션을 사용할 수 있습니다.
   ...
   * **[!UICONTROL ID 부재 승인]** 옵션을 사용하면 모든 방문자가 랜딩 페이지에 액세스할 수 있습니다. 이 옵션을 선택 해제하면 익명 방문자가 사용할 수 없습니다. 즉, 식별된 사용자만 양식에 액세스하고 양식을 제출할 수 있습니다.
     ...
     **[!UICONTROL 획득]** 및 **[!UICONTROL 구독]** 템플릿의 경우 기본적으로 이 옵션이 선택됩니다. **[!UICONTROL 구독 취소]** 및 **[!UICONTROL 차단 목록]** 템플릿의 경우 이 옵션은 기본적으로 선택되지 않으며 수정할 수 없습니다<!--as per ticket - TBC? in that case, is it greyed out or doesn't display?-->.
...
1. 랜딩 페이지의 시작 날짜와 종료 날짜를 정의할 수 있습니다. **[!UICONTROL 예약 사용]**&#x200B;을 선택하고 날짜를 설정합니다.
   ...
   * 페이지가 종료되면 <!--the landing page is automatically unpublished and -->양식을 더 이상 사용할 수 없습니다. 대신 **[!UICONTROL 만료]** 페이지가 표시됩니다.
...
모든 설정 및 [디자인](lp-content.md)을(를) 정의하면 아래와 같이 랜딩 페이지를 [테스트](#test-landing-page)하고 [게시](#publish-landing-page)할 수 있습니다.
