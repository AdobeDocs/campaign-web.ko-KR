...
>title="연락 일자 및 시간 설정"
>abstract="게재를 전송하는 일자와 정확한 시간을 정의합니다. 마케팅 메시지에 가장 적합한 시간을 선택하여 열람률을 극대화할 수 있습니다."

메시지를 보내는 날짜와 정확한 시간을 설정할 수 있습니다. 마케팅 메시지에 가장 적합한 시간을 선택하여 열람률을 극대화할 수 있습니다.

게재 전송을 예약하려면 다음 단계를 따르십시오.

1. 게재를 열고 **[!UICONTROL 일정]** 섹션으로 이동합니다.
1. **[!UICONTROL 예약 활성화]** 토글을 사용하여 활성화하십시오.
1. **[!UICONTROL 연락처 날짜]** 필드에서 달력 아이콘을 클릭하고 원하는 전송 날짜와 시간을 설정합니다.
1. **[!UICONTROL 시간대]** 필드에서 드롭다운 메뉴를 사용하여 원하는 시간대를 선택합니다.

게재를 전송하면 정의한 연락 날짜에 실제 전송이 시작됩니다.

![게재 예약 인터페이스를 보여주는 스크린샷](assets/schedule.png){zoomable="yes"}

기본적으로 **[!UICONTROL 전송 전에 확인 활성화]** 옵션이 활성화되어 있습니다. 이 옵션을 사용하려면 예약된 날짜에 게재를 보내기 전에 전송을 확인해야 합니다. 예약된 날짜와 시간에 게재를 자동으로 보내야 하는 경우 이 옵션을 비활성화할 수 있습니다.
