...
>title="게재"
>abstract="게재는 특정 채널(이메일, SMS 또는 푸시 알림)의 대상자에게 전송되는 마케팅 커뮤니케이션입니다. 게재 목록에서 기존 게재를 편집하고 상태, 연락처 및 수정 날짜, KPI를 확인할 수 있습니다. “게재 만들기” 버튼을 클릭하여 새 게재를 추가합니다. 게재를 선택하여 콘텐츠, 일정, 대상자 및 세부 사항을 확인합니다."
