...
이러한 메시지는 게재를 통해 디자인되고 전송되며 각 수신자에 대해 개인화할 수 있습니다. 이러한 게재는 독립 실행형이거나 마케팅 캠페인 컨텍스트에 포함될 수 있습니다.

Adobe Campaign v8에는 이메일, SMS 및 모바일 앱과 같은 게재 채널이 포함되어 있습니다.
...
게재는 게재 목록(왼쪽 레일의 기본 게재 항목 또는 캠페인의 게재 목록)에서 삭제됩니다.
...
이 목록에서 모든 게재를 사용할 수 있지만 워크플로우에서 만든 게재는 목록에서 삭제할 수 없습니다. 워크플로우 컨텍스트에서 생성된 게재를 삭제하려면 워크플로우에서 게재 활동을 삭제해야 합니다.

워크플로우에서 게재를 삭제하려면 다음 단계를 수행합니다.

1. 게재 활동 을 선택합니다.
1. 다음을 클릭합니다.  **[!UICONTROL 삭제]** 오른쪽 패널의 아이콘
1. 삭제를 확인합니다. 게재에 하위 노드가 있는 경우 삭제하거나 보유하도록 선택할 수도 있습니다.

![워크플로우에서 게재 삭제](assets/delete-delivery-from-wf.png)
