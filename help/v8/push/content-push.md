...
>abstract="Android 디바이스에 대한 푸시 알림의 콘텐츠를 정의합니다. 메시지 작성을 시작하려면 **콘텐츠 편집** 단추를 클릭합니다."

>[!CONTEXTUALHELP]
>id="acw_deliveries_push_ios_content"
>title="iOS 콘텐츠 푸시"
>abstract="iOS 디바이스에 대한 푸시 알림의 콘텐츠를 정의합니다. 메시지 작성을 시작하려면 **콘텐츠 편집** 단추를 클릭합니다."
...
>title="iOS 메시지 푸시"
>abstract="iOS 디바이스에 대한 푸시 알림의 콘텐츠를 정의합니다. 메시지를 작성하려면 **제목** 및 **메시지** 필드. 표현식 편집기를 사용하여 데이터를 개인화하고 다이내믹 콘텐츠를 추가합니다. 사용자 지정 구성을 더 보려면 **고급 설정** 섹션."


>[!CONTEXTUALHELP]
>id="acw_deliveries_push_android_msg"
>title="iOS 메시지 푸시"
>abstract="Android 디바이스에 대한 푸시 알림의 콘텐츠를 정의합니다. 메시지를 작성하려면 **제목** 및 **메시지** 필드. 표현식 편집기를 사용하여 데이터를 개인화하고 다이내믹 콘텐츠를 추가합니다. 푸시 알림을 추가로 개인화하려면 푸시 알림에 추가할 이미지, 프로필 디바이스에 표시할 알림의 아이콘 및 색상을 선택할 수 있습니다. 사용자 지정 구성을 더 보려면 **고급 설정** 섹션."
...
* 다음 **[!UICONTROL 알림 메시지]** FCM SDK에 의해 자동으로 처리됩니다. FCM은 클라이언트 앱을 대신하여 사용자의 장치에 메시지를 자동으로 표시합니다. 알림 메시지에는 사전 정의된 매개 변수 및 옵션 세트가 포함되어 있지만 사용자 지정 애플리케이션 변수를 사용하여 추가로 개인화할 수 있습니다.
  ...
  메시지를 작성하려면 **[!UICONTROL 제목]** 및 **[!UICONTROL 메시지]** 필드. 표현식 편집기를 사용하여 콘텐츠를 정의하고, 데이터를 개인화하고, 다이내믹 콘텐츠를 추가합니다.
