...
* **워크플로**: 워크플로에 푸시 채널 활동을 추가하고 기본 설정을 구성하면 오른쪽 창 메뉴에서 푸시 알림의 콘텐츠를 만들 수 있습니다. 워크플로우 구성 방법에 대한 자세한 지침은 다음을 참조하십시오. [이 페이지](../workflows/gs-workflows.md).

* **캠페인**: 캠페인이 생성되면 푸시 알림 게재를 만들 수 있습니다. 캠페인 설정에 대한 자세한 내용은 다음을 참조하십시오. [이 페이지](../campaigns/gs-campaigns.md).
