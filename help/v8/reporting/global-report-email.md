...
* **[!UICONTROL 바운스 수 및 오류 수]**: 보낸 총 메시지 수와 관련하여 게재 및 자동 반환 처리 중 누적된 총 오류 수입니다.
...
![게재 처리량 지표](assets/global_report_email_delivery_throughput.png){zoomable="yes"}{align="center"}
