...
* **시각적 조각**&#x200B;은 여러 이메일 게재 또는 콘텐츠 템플릿에서 재사용할 수 있는 사전 정의된 시각적 블록입니다. [자세히 알아보기](../email/fragments.md)
...
>[!AVAILABILITY]
>
>이 기능을 사용하려면 Campaign v8.6.3 또는 v8.7.2로 업데이트해야 합니다. [Campaign v8 클라이언트 콘솔 릴리스 정보](https://experienceleague.adobe.com/ko/docs/campaign/campaign-v8/releases/release-notes)에서 자세히 알아보십시오.
