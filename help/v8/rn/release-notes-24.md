---
title: Campaign v8 웹 사용자 인터페이스 이전 릴리스 정보
description: 2024년 Campaign 웹 사용자 인터페이스 릴리스
...
이 페이지에는 **2024 릴리스**&#x200B;에서 사용할 수 있는 모든 변경 사항 및 개선 사항이 나와 있습니다. 최신 릴리스 노트는 [이 페이지](release-notes.md)에서 확인할 수 있습니다.
