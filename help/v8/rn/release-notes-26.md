...
description: 2026 Campaign Web 사용자 인터페이스 릴리스
...
# 2026 릴리스 정보 {#2026-release}

이 페이지에는 **2026 릴리스**&#x200B;에서 사용할 수 있는 모든 변경 사항 및 개선 사항이 나와 있습니다. [이 페이지](release-notes.md)에서 최신 릴리스 정보를 사용할 수 있습니다.
