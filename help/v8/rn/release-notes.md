...
>[!AVAILABILITY]
>
>이러한 업데이트의 혜택을 받으려면 서버를 8.8.1 미니넘으로 업그레이드해야 합니다. 클라이언트 콘솔 [릴리스 정보](https://experienceleague.adobe.com/docs/campaign/campaign-v8/releases/release-notes.html?lang=ko){target="_blank"}를 참조하세요.
