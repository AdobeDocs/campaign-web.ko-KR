...
<img src="assets/do-not-localize/typology.gif" alt="Adobe Campaign Web 사용자 인터페이스의 유형화 규칙 생성 일러스트레이션">
...
<tr>
<td>
<p>이제 Campaign Web 사용자 인터페이스에서 대상 매핑을 만들 수 있습니다. 대상 매핑은 다양한 게재 채널(이메일, SMS, 푸시 알림)이 스키마의 데이터 필드에 연결되는 방식을 정의합니다. 대상 매핑을 통해 프로필, 약정 수혜자, 운영자, 구독자, 잠재 고객 등 타기팅되는 대상자를 정의합니다.</p>
<img src="assets/do-not-localize/target-mapping.gif" alt="Adobe Campaign Web 사용자 인터페이스의 대상 매핑 생성 일러스트레이션">
...
<img src="assets/do-not-localize/schemas.gif" alt="Adobe Campaign Web 사용자 인터페이스의 스키마 세부 정보 및 사용자 정의 필드 편집 일러스트레이션">
...
<img src="assets/do-not-localize/visual-fragment.gif" alt="Adobe Campaign Web 사용자 인터페이스의 시각적 조각 생성 및 사용 일러스트레이션">
...
<img src="assets/do-not-localize/external-delivery.gif" alt="Adobe Campaign Web 사용자 인터페이스의 외부 게재 설정 일러스트레이션">
...
<img src="assets/do-not-localize/enumerations.gif" alt="Adobe Campaign Web 사용자 인터페이스의 열거 관리 일러스트레이션">
...
<img src="assets/do-not-localize/options.gif" alt="Adobe Campaign Web 사용자 인터페이스의 사용자 정의 옵션 생성 일러스트레이션">
...
<img src="assets/do-not-localize/javascript.gif" alt="Adobe Campaign Web 사용자 인터페이스의 JavaScript 코드 생성 일러스트레이션">
...
<img src="assets/do-not-localize/ai-lp.gif" alt="Adobe Campaign Web 사용자 인터페이스의 랜딩 페이지 생성을 위한 AI 어시스턴트 사용 일러스트레이션">
...
* 인터페이스에서 사용자 정의 필드의 표시 사용자 정의:
   * 인터페이스에서 표시할 추가 사용자 정의 필드를 선택합니다.
   * 다른 필드의 입력에 따라 목록 값을 제한하는 것과 같이 링크 유형 사용자 정의 필드를 표시하기 위한 규칙을 설정합니다.
   * 인터페이스에서 필드를 보다 유연하게 배열할 수 있습니다. 필드를 단일 열에 걸쳐 배치하거나 더 나은 구성을 위해 하위 섹션으로 그룹화합니다.
   * 특정 필드를 읽기 전용으로 설정합니다.

* 최근 항목 및 즐겨찾기 필터: 바로 가기를 위해 자주 사용하는 속성을 즐겨찾기에 추가합니다. 즐겨찾기 외에도 가장 최근에 선택한 속성을 조회하고 사용합니다.
