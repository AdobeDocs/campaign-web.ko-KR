...
이제 **대상자 작성** 워크플로우 활동(쿼리 유형)에서 **데이터 보강** 섹션을 사용할 수 있습니다. Campaign 웹 사용자 인터페이스에서 직접 **추가 데이터**&#x200B;를 보고, 추가하고, 편집하고, 제거할 수 있습니다. **데이터 보강** 활동에서와 같이, 단일 데이터 보강 특성, 컬렉션 링크 및 식을 추가할 수 있습니다.
