...
**Adobe Campaign**&#x200B;을(를) 사용하면 메시지를 기본 대상자에게 보내기 전에 테스트할 수 있습니다. 이는 이메일 캠페인의 유효성을 검사하고 잠재적인 문제를 식별하는 데 필수적인 단계입니다.
...
![](../assets/do-not-localize/book.png) [이 섹션](../preview-test/test-deliveries.md)에서 증명을 보내는 방법을 알아봅니다.
...
1. 마지막 전송 프로세스를 진행하려면 **[!UICONTROL 보내기]**&#x200B;를 클릭하여 메시지를 보냅니다.
   ...
   SMS 게재를 예약한 경우 **[!UICONTROL 일정대로 보내기]** 단추를 클릭합니다. [이 섹션](../msg/gs-messages.md#schedule-the-delivery-sending)에서 게재 예약에 대해 자세히 알아보세요.
