...
>title="종료 활동"
>abstract="**시작** 활동을 사용하여 워크플로의 시작을 그래픽으로 표시할 수 있습니다. 이 활동은 기능에 영향을 미치지 않으므로 선택 사항입니다."
...
* [가입](join.md): 워크플로우의 여러 실행 분기를 동기화합니다.
* [스케줄러](scheduler.md): 워크플로우가 시작되는 시기를 예약합니다.
* **시작** 및 **끝**: 워크플로우의 시작과 끝을 그래픽으로 표시합니다. 이는 선택 사항이며 그 자체로 기능적인 영향을 미치지 않습니다.

  >[!NOTE]
  >
  >**시작** 활동은 26.3 릴리스 전에 만든 모든 워크플로우에 자동으로 추가됩니다. 기본적으로 새 워크플로우에는 삽입되지 않습니다.
