...
Adobe Campaign 웹을 사용하면 여러 채널에서 마케팅 캠페인을 자동화하고 실행할 수 있습니다. 채널 활동을 캔버스에 결합하여 고객 행동에 따라 작업을 트리거할 수 있는 크로스 채널 워크플로우를 만들 수 있습니다. 전자 메일, SMS, Android 및 iOS 푸시 알림과 같은 **채널** 활동을 사용할 수 있습니다. [워크플로우 컨텍스트에서 게재를 설정하는 방법을 알아봅니다](channels.md).
