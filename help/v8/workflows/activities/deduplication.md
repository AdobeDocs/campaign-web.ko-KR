...
>title="중복 제거 활동"
>abstract="**중복 제거** 활동은 인바운드 활동의 결과에서 중복 요소를 삭제합니다. 주로 타기팅 활동 이후와 대상 데이터를 사용하는 활동 이전에 사용됩니다."
...
1. **중복 요소를 식별할 수 있는 필드** 섹션에서 **속성 추가** 버튼을 클릭하여 동일한 값을 통해 중복 항목을 식별할 수 있는 이메일 주소, 이름, 성 등의 필드를 지정할 수 있습니다. 필드의 순서는 먼저 처리할 필드를 지정합니다. [특성을 선택하고 즐겨찾기에 추가하는 방법을 알아보세요](../../get-started/attributes.md).
