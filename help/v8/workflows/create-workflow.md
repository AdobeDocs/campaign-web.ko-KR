...
>title="캠페인의 워크플로우 목록"
>abstract="**워크플로우** 탭에는 현재 캠페인에 연결된 워크플로우가 모두 나열됩니다. 편집하려면 워크플로우 이름을 클릭하십시오. **워크플로우 만들기** 버튼을 사용하여 이 캠페인에 새 워크플로우를 추가합니다."
...
>title="워크플로우 템플릿"
>abstract="워크플로우 템플릿에는 새 워크플로우를 만드는 데 재사용할 수 있는 사전 구성된 설정 및 활동이 포함되어 있습니다."

>[!CONTEXTUALHELP]
>id="acw_workflow_template_creation_properties"
>title="워크플로 속성"
>abstract="워크플로우 템플릿에는 새 워크플로우를 만드는 데 재사용할 수 있는 사전 구성된 설정 및 활동이 포함되어 있습니다. 이 화면에서는 워크플로우 템플릿의 레이블을 입력하고 내부 이름, 폴더 및 실행 폴더, 시간대, 감독자 그룹 등의 설정을 구성합니다."

워크플로우 템플릿에는 새 워크플로우를 만드는 데 재사용할 수 있는 사전 구성된 설정 및 활동이 포함되어 있습니다. 워크플로우를 만들 때 워크플로우 속성에서 워크플로우의 템플릿을 선택할 수 있습니다. 기본적으로 빈 템플릿이 제공됩니다.
