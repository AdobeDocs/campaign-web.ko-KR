...
>title="워크플로 속성"
>abstract="이 섹션에서는 워크플로우를 만들 때도 액세스할 수 있는 일반 워크플로우 속성을 제공합니다. 워크플로를 만드는 데 사용할 템플릿을 선택하고 레이블을 지정할 수 있습니다. 추가 옵션 섹션을 확장하여 폴더 또는 시간대 저장 워크플로와 같은 특정 설정을 구성합니다."
...
>title="실행 설정"
>abstract="이 섹션에서는 워크플로우 내역이 보관되는 일수와 같이 워크플로우 실행과 관련된 설정을 구성할 수 있습니다."
...
>title="오류 관리 설정"
>abstract="이 섹션에서는 실행 중에 오류가 발생할 때(실행 일시 중지/중지 또는 오류 무시) 워크플로우의 동작 방법을 관리할 수 있습니다."
